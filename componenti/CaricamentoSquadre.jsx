...
const CURIOSITA = [
  {
    ...
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Paolo_Maldini_AC_Milan_Technical_director_2018.jpg/220px-Paolo_Maldini_AC_Milan_Technical_director_2018.jpg",
    alt: "Paolo Maldini",
  },
  {
    testo: "Francesco Totti ha segnato per la Roma in Serie A per 22 stagioni consecutive.",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/KL-2018_%284%29.jpg/220px-KL-2018_%284%29.jpg",
    alt: "Francesco Totti",
  },
  {
    testo: "Nel 1986-87 Diego Maradona trascinò il Napoli al primo Scudetto della sua storia.",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Argentina_celebrando_copa_%28cropped%29.jpg/220px-Argentina_celebrando_copa_%28cropped%29.jpg",
    alt: "Diego Maradona",
  },
  {
    testo: "Gianluigi Buffon ha vestito la maglia della Nazionale in 5 diverse edizioni dei Mondiali.",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Norway_Italy_-_June_2025_A_44_%28Gianluigi_Buffon%29.jpg/220px-Norway_Italy_-_June_2025_A_44_%28Gianluigi_Buffon%29.jpg",
    alt: "Gianluigi Buffon",
  },
  {
    testo: "Andrea Pirlo, scartato dal Milan nel 2011, vinse 4 Scudetti consecutivi con la Juventus.",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/20150616_-_Portugal_-_Italie_-_Gen%C3%A8ve_-_Andrea_Pirlo_%28cropped%29.jpg/220px-20150616_-_Portugal_-_Italie_-_Gen%C3%A8ve_-_Andrea_Pirlo_%28cropped%29.jpg",
    alt: "Andrea Pirlo",
  },
  {
    testo: "Alessandro Del Piero ha segnato più di 200 gol in Serie A, tutti con la maglia della Juventus.",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/25th_Laureus_World_Sports_Awards_-_Alessandro_Del_Piero_-_240421_155220_%28cropped%29.jpg/220px-25th_Laureus_World_Sports_Awards_-_Alessandro_Del_Piero_-_240421_155220_%28cropped%29.jpg",
  ...
  },
  {
    ...
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/%D8%B1%D9%88%D8%A8%D8%B1%D8%AA%D9%88_%D8%A8%D8%A7%D8%AC%D9%88_%28cropped%29.jpg/220px-%D8%B1%D9%88%D8%A8%D8%B1%D8%AA%D9%88_%D8%A8%D8%A7%D8%AC%D9%88_%28cropped%29.jpg",
    alt: "Roberto Baggio",
  },
  {
    testo: "Fabio Cannavaro è l'unico difensore ad aver vinto il Pallone d'Oro nel nuovo millennio.",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Fabio_Cannavaro_2011.jpg/220px-Fabio_Cannavaro_2011.jpg",
    alt: "Fabio Cannavaro",
  },
  {
    testo: "Javier Zanetti ha giocato per un solo club, l'Inter, per 19 stagioni consecutive.",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Metalist-Inter_%282%29.jpg/220px-Metalist-Inter_%282%29.jpg",
    alt: "Javier Zanetti",
  },
  {
    testo: "Zlatan Ibrahimović ha vinto lo Scudetto con tre squadre diverse: Juventus, Inter e Milan.",
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Zlatan_Ibrahimovi%C4%87_June_2018.jpg/220px-Zlatan_Ibrahimovi%C4%87_June_2018.jpg",
    ...
    <div className="attesa-squadre">
      ...
      <div key={curiosita.chiave} className="attesa-figurina">
        <div className="attesa-figurina-foto">
          {curiosita.img ? (
            <img src={curiosita.img} alt={curiosita.alt} loading="lazy" referrerPolicy="no-referrer" />
          ) : (
